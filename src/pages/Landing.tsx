...
import { ArrowRight, Zap, Shield, Globe, QrCode, Wallet, Users, Star, TrendingUp, Heart, Rocket, CheckCircle } from 'lucide-react'
...
export function Landing() {
  ...
  const dynamicStats = {
    ...
    totalVolume: platformStats?.totalVolume || BigInt(2500000000000000000000000) // 2.5M em wei
  }
        ...
        <div className="container relative flex flex-col items-center justify-center space-y-8 py-24 md:py-32">
          <div className="flex flex-col items-center space-y-6 text-center">            
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <Link to="/explore">
                <Button size="xl" className="w-full sm:w-auto group relative overflow-hidden">
        ...
        <div className="container relative">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl bg-gradient-to-br from-gray-900 to-gray-600 bg-clip-text text-transparent dark:from-gray-100 dark:to-gray-400">
              Built for Creators,
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> Loved by Everyone</span>
            </h2>
            <p className="mt-6 text-lg text-muted-foreground max-w-[700px] mx-auto leading-relaxed">
              Experience the future of creator monetization with cutting-edge Web3 technology
              that's simple, secure, and accessible to all.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Login with Google, email, or social accounts. Create a wallet instantly without seed phrases.",
                color: "text-blue-500",
              ...
              },
              {
                ...
                description: "Zero gas fees for all users. We sponsor your transactions for seamless onboarding.",
              ...
              },
              {
                ...
                description: "Send and receive tips on Base, Ethereum, Solana, and more. One platform, any chain.",
              ...
              },
              {
                ...
                description: "Generate QR codes and shareable links. Add to Instagram, Twitter, YouTube, or anywhere.",
              ...
              },
              {
                icon: Shield,
                title: "Secure & Safe",
                description: "Built on Base L2 with Coinbase Smart Wallets. Your funds are always secure.",
                color: "text-red-500",
              ...
              },
              {
                ...
                description: "Get your own username.base.eth identity. Easy to remember, easy to share.",
                color: "text-orange-500",
                gradient: "from-orange-500 to-red-500"
              }
            ].map((feature, index) => (
              <Card key={index} className="group relative overflow-hidden border-0 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
                <CardHeader className="relative z-10">
                  <div className={`inline-flex items-center justify-center p-3 rounded-2xl bg-gradient-to-r ${feature.gradient} mb-4 group-hover:scale-110 transition-transform duration-300`}>
            ...
            {[
              {
                ...
                description: "Connect with email, Google, or your favorite social account. No crypto wallet required.",
                icon: Users,
              ...
              },
              {
                ...
                description: "Browse creators or use a direct link. Scan a QR code or search by basename.",
                icon: QrCode,
              ...
              },
              {
                step: "3",
                title: "Send Your Tip",
                description: "Choose an amount, add a message, and send. Pay with card, crypto, or any token.",
                icon: Heart,
                color: "from-pink-500 to-red-500",
                features: ["Multiple Payments", "Personal Messages", "Instant Delivery"]
              }
            ].map((step, index) => (
              <div key={index} className="group text-center">
                <div className="relative">
                  <div className={`absolute inset-0 bg-gradient-to-r ${step.color} rounded-3xl blur-lg opacity-20 group-hover:opacity-30 transition-opacity duration-300`} />
                  <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 dark:border-gray-700/50 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <step.icon className={`h-12 w-12 mx-auto mb-4 text-transparent bg-gradient-to-r ${step.color} bg-clip-text`} />
        ...
        <div className="container relative">
          <div className="text-center space-y-8 px-4 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white/90 max-w-[700px] mx-auto leading-relaxed">
              ...
              Set up your profile in less than 2 minutes and start receiving tips today.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              <Link to="/creators">
                <Button size="xl" variant="secondary" className="w-full sm:w-auto group relative overflow-hidden">
                  <span className="relative z-10 flex items-center">
                    Create Your Profile
                    <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                  </span>
        ...
        <div className="container py-16">
          <div className="grid gap-8 md:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Support creators without friction. Built on Base with love for the community.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li><Link to="/explore" className="hover:text-foreground transition-colors duration-200 flex items-center group">
                  <ArrowRight className="h-3 w-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                  Explore Creators
                </Link></li>
                <li><Link to="/how-it-works" className="hover:text-foreground transition-colors duration-200 flex items-center group">
                  <ArrowRight className="h-3 w-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                  How It Works
                </Link></li>
                <li><Link to="/creators" className="hover:text-foreground transition-colors duration-200 flex items-center group">
                  <ArrowRight className="h-3 w-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                  For Creators
                </Link></li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li><a href="https://docs.tipchain.app" className="hover:text-foreground transition-colors duration-200">Documentation</a></li>
                <li><a href="https://github.com/tipchain" className="hover:text-foreground transition-colors duration-200">GitHub</a></li>
          ...
          <div className="mt-16 pt-8 border-t text-center">
            <p className="text-sm text-muted-foreground">
              © 2025 TipChain. Built for Base Batch 002 & Reown AppKit Competition.
