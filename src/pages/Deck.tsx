  ...
  const slides = [
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          label: "SAM",
          value: "50M",
          description: "Active monetization seekers",
        },
        {
          label: "SOM",
          value: "1M",
          description: "Base ecosystem + early adopters",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      team: [
        {
          role: "Founder",
          experience: "Full-stack developer with 5+ years in Web3",
        },
        {
          role: "Advisors",
          experience: "Base ecosystem experts & creator economy specialists",
        },
      ],
      roadmap: [
      ...
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold tracking-tight mb-4">
            TipChain Investor Deck
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Revolutionizing creator monetization with zero-friction crypto
            tipping
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-4">
                  {currentSlide.achievements?.map((achievement, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-3 p-4 border rounded-lg bg-green-50"
                    >
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-2">
            <Button variant="outline" asChild>
              <a
                href="https://github.com/developerfred/tipchain"
                target="_blank"
